...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateCartItemList() {
    ...
    cartItems.forEach((item, index) => {
      ...
      cartItem.innerHTML = `
            ...
            <button class="remove-item" data-index="${index}"><i class="fas fa-solid fa-times"></i></button>
        `;
  ...
  function removeItemFromCart(index) {
    const removeItem = cartItems.splice(index, 1)[0]; // Changed CartItems to cartItems
